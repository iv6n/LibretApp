...
void _isarMilkingSessionSerialize(
  ...
  writer.writeString(offsets[5], object.shift);
  writer.writeString(offsets[6], object.sourceLoteUuid);
...
IsarMilkingSession _isarMilkingSessionDeserialize(
  ...
  object.shift = reader.readString(offsets[5]);
  object.sourceLoteUuid = reader.readStringOrNull(offsets[6]);
...
extension IsarMilkingSessionQueryProperty
  ...
  QueryBuilder<IsarMilkingSession, bool, QQueryOperations> syncedProperty() {
    return QueryBuilder.apply(this, (query) {
