...
class RegistroCostoPage extends StatefulWidget {
  const RegistroCostoPage({super.key});

  @override
  State<RegistroCostoPage> createState() => _RegistroCostoPageState();
}

class _RegistroCostoPageState extends State<RegistroCostoPage> {
  ...
  Future<void> _save() async {
    ...
    _bloc.add(AddCostRecord(animalUuid: _selectedAnimal!.uuid, record: record));
