...
extension IsarIncomeRecordByIndex on IsarCollection<IsarIncomeRecord> {
  Future<IsarIncomeRecord?> getByRecordUuid(String recordUuid) {
    return getByIndex(r'recordUuid', [recordUuid]);
  }

  IsarIncomeRecord? getByRecordUuidSync(String recordUuid) {
  ...
  Future<List<IsarIncomeRecord?>> getAllByRecordUuid(
  ...
  List<IsarIncomeRecord?> getAllByRecordUuidSync(
    List<String> recordUuidValues,
  ) {
    final values = recordUuidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByRecordUuid(IsarIncomeRecord object) {
    return putByIndex(r'recordUuid', object);
  }

  Id putByRecordUuidSync(IsarIncomeRecord object, {bool saveLinks = true}) {
    return putByIndexSync(r'recordUuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRecordUuid(List<IsarIncomeRecord> objects) {
    return putAllByIndex(r'recordUuid', objects);
  }

  List<Id> putAllByRecordUuidSync(
    List<IsarIncomeRecord> objects, {
    bool saveLinks = true,
  }) {
...
extension IsarIncomeRecordQueryFilter
  ...
  animalUuidIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'animalUuid'),
      );
    });
  }
  ...
  animalUuidIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'animalUuid'),
      );
    });
  }
