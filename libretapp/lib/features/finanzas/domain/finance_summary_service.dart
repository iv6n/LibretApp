/// features › finanzas › domain › finance_summary_service — shared financial aggregates.
///
/// Used by both `inicio` (home dashboard) and `reportes` (financial tab) —
/// lives under `finanzas/` because every dependency it has is finanzas- or
/// animal-domain, not perfil-specific.
library;
