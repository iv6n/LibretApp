...
extension IsarWeightRecordByIndex on IsarCollection<IsarWeightRecord> {
  Future<IsarWeightRecord?> getByRecordUuid(String recordUuid) {
    return getByIndex(r'recordUuid', [recordUuid]);
  }

  IsarWeightRecord? getByRecordUuidSync(String recordUuid) {
  ...
  Future<Id> putByRecordUuid(IsarWeightRecord object) {
    return putByIndex(r'recordUuid', object);
  }

  Id putByRecordUuidSync(IsarWeightRecord object, {bool saveLinks = true}) {
    return putByIndexSync(r'recordUuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRecordUuid(List<IsarWeightRecord> objects) {
