...
void _isarHealthRecordSerialize(
  ...
  writer.writeLong(offsets[11], object.withdrawalDays);
  writer.writeDateTime(offsets[12], object.withdrawalEndDate);
}
...
IsarHealthRecord _isarHealthRecordDeserialize(
  ...
  object.withdrawalDays = reader.readLongOrNull(offsets[11]);
  object.withdrawalEndDate = reader.readDateTimeOrNull(offsets[12]);
  return object;
}
...
extension IsarHealthRecordByIndex on IsarCollection<IsarHealthRecord> {
  Future<IsarHealthRecord?> getByRecordUuid(String recordUuid) {
    return getByIndex(r'recordUuid', [recordUuid]);
  }

  IsarHealthRecord? getByRecordUuidSync(String recordUuid) {
  ...
  Future<Id> putByRecordUuid(IsarHealthRecord object) {
    return putByIndex(r'recordUuid', object);
  }

  Id putByRecordUuidSync(IsarHealthRecord object, {bool saveLinks = true}) {
    return putByIndexSync(r'recordUuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRecordUuid(List<IsarHealthRecord> objects) {
