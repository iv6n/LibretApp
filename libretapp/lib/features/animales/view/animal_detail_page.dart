...
import 'package:libretapp/features/animales/application/bloc/animal_state.dart';
import 'package:libretapp/features/animales/domain/entities/commercial_record.dart';
...
import 'package:libretapp/features/animales/domain/entities/movement_record.dart';
import 'package:libretapp/features/animales/domain/entities/production_record.dart';
import 'package:libretapp/features/animales/domain/entities/reproduction_record.dart';
import 'package:libretapp/features/animales/domain/entities/weight_record.dart';
      ...
      body: FutureBuilder<DetailData>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return DetailError(message: '${snapshot.error}', onRetry: _reload);
          }
          ...
          Padding(
            ...
            child: Align(
              ...
              child: OutlinedButton.icon(
                ...
                label: const Text('Cambiar ubicación/lote'),
                onPressed: () => _openLocationBatchSheet(data),
              ),
            ),
          ),
